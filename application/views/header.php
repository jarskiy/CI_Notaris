...
<head>
    ...
    <link rel="stylesheet"
        href="<?= base_url('/assets/template/vendors/datatables/css/dataTables.bootstrap5.min.css') ?>">
    ...
    <link rel="stylesheet"
        href="<?= base_url('/assets/template/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css') ?>">
    ...
    <script src="<?= base_url('/assets/template/vendors/moment/moment.min.js') ?>"></script>
    <script src="<?= base_url('/assets/template/vendors/moment/moment-with-locales.min.js') ?>"></script>
    <script src="<?= base_url('/assets/template/vendors/moment/locale/id.js') ?>"></script>
    <!-- endinject -->
    <script>
            ...
            <ul class="nav">
                ...
                if ($_SESSION['menu_master']) {
                    ...
                    if (isset($_SESSION['akses_modul']['klasifikasi']) && $_SESSION['akses_modul']['klasifikasi'] == 'on') {
                        echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"" . site_url('admin/klas') . "\"><i class=\"fa fa-tag\"></i>&nbsp; Jenis Klasifikasi</a></li>";
                    }
        ...
        <div class="container-fluid page-body-wrapper">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                    ...
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item d-none d-lg-block">
                            <!-- SEARCH FORM -->
                            <form class="ms-auto search-form d-none d-md-block" method="get"
                                action="<?= site_url('/home/search'); ?>">
                                <div class="input-group">
                                    <input name="katakunci" class="form-control form-control-sm" type="search"
                                        placeholder="nomor arsip/kata kunci" aria-label="Search">
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item">
                            <div class="text-primary">
                                <span id="tanggalan"></span>, <span id="jam"></span>
                            </div>
                        </li>
                        <li class="nav-item dropdown user-dropdown">
                            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img src="<?= base_url() ?>assets/images/Portrait_Placeholder.png" width="30"
                                    alt="profile" />&nbsp;
                                <span class="nav-profile-name"><?= $_SESSION['username']; ?></span></a>
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                                ...
                                <a class="dropdown-item" href="<?= site_url('pengaturan/profil'); ?>"><i
                                        class="dropdown-item-icon mdi mdi-account text-primary"></i>Profil</a>
                                <?php if ($_SESSION['tipe'] == 'admin') { ?>
                                <a class="dropdown-item" href="<?= site_url('pengaturan'); ?>"><i
                                        class="dropdown-item-icon mdi mdi-settings text-primary"></i>Pengaturan</a>
                                <?php } ?>
                                <a class="dropdown-item" href="<?= site_url('home/logout'); ?>"><i
                                        class="dropdown-item-icon mdi mdi-power text-primary"></i>Logout</a>
                            </div>
                        </li>
                    </ul>

                    <button class="navbar-toggler navbar-toggler-icon navbar-toggler-right d-lg-none align-self-center"
                        type="button" data-toggle="offcanvas"></button>
                </div>
                <!-- /.container -->
            </nav>
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <!-- SEARCH FORM -->
                    <form class="ml-auto search-form d-md-none d-lg-none d-xl-none d-sm-block mb-3" method="get"
                        action="<?= site_url('/home/search'); ?>">
                        <div class="input-group">
                            <input name="katakunci" class="form-control" type="search"
                                placeholder="nomor arsip/kata kunci uraian" aria-label="Search">
                            <div class="input-group-append">
                                <button class="btn bg-primary text-white" type="submit">
                                    <i class="fa fa-search"></i>
                                </button>
