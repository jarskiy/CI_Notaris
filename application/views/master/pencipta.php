...
?>
<h2 class="mb-3">Master Pencipta Arsip</h2>

<div class="card">
  <div class="card-header">
    <?php if (isset($_SESSION['akses_modul']['pencipta']) && $_SESSION['akses_modul']['pencipta'] == 'on') : ?>
      <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#addpenc"><i class="fa fa-plus"></i> Tambah Baru</a>
    <?php endif; ?>
  </div>
  <div class="card-body">
    <div class="row">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header py-3">
        <h5 class="modal-title">Tambah Pencipta Arsip</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="faddpenc" class="form-horizontal" role="form" method="post" action="<?= site_url("/admin/addpenc"); ?>">
...
<div class="modal fade" id="editpenc">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header py-3">
        <h5 class="modal-title">Edit Pencipta Arsip</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="fedpenc" class="form-horizontal" role="form" method="post" action="<?= site_url("/admin/edpenc"); ?>">
...
<div class="modal fade" id="delpenc">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header py-3">
        <h5 class="modal-title">Delete Pencipta Arsip</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="fdelpenc" class="form-horizontal" role="form" method="post" action="<?= site_url("/admin/delpenc"); ?>">
