...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="Form" class="form-horizontal" data-toggle="validator" action="<?= site_url('/sirkulasi/gentr'); ?>"
            method="post" enctype="multipart/form-data">

            <div class="form-group">
                <label class="control-label" for="noakta">Nomor Akta</label>
                <input type="text" id="snoakta" name="noakta" class="form-control xhr"
                    placeholder="Ketikan kode akta atau klasifikasi akta"
                    data-xhr="<?= site_url('/sirkulasi/xhr_akta'); ?>" autocomplete="off" required />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="username_peminjam" name="username_peminjam" class="form-control xhr"
                    placeholder="Ketikan username yang akan meminjam" data-xhr="<?= site_url('/sirkulasi/xhr_user'); ?>"
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text" style="height: 50px;"><i
                                class="mdi mdi-calendar text-secondary"></i></span>
                    </div>
                    <input id="tgl_pinjam" name="tgl_pinjam" class="form-control" type="text"
                        value="<?php print $now ?>" required>
