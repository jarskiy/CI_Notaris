...
<h2 class="mb-3">Edit Sirkulasi</h2>
	...
	<div class="card-body">
		<form class="form-horizontal" data-toggle="validator" action="<?= site_url('/sirkulasi/update'); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" value="<?= $noakta ?>" id="snoakta" name="noakta" class="form-control disabled xhr" placeholder="Ketikan 3 huruf/angka pertama kode akta atau klasifikasi akta" data-xhr="<?= site_url('/sirkulasi/xhr_akta'); ?>" autocomplete="off" readonly required />
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input id="tgl_pinjam" name="tgl_pinjam" class="form-control" type="text" value="<?= $tgl_pinjam; ?>" required>
				</div>
			</div>
