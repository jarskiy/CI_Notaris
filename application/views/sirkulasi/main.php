...
<div class="row mb-3">
    <div class="col-12">
        <div class="page-header">
            <h2>Data Peminjaman (<?= number_format($jml); ?>)</h2>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        ...
        <a class="btn btn-primary" href="<?= site_url('/sirkulasi/entr'); ?>"><i class="fa fa-plus"></i> Peminjaman
            Baru</a>
        <?php endif; ?>
    </div>
    <div class="card-body">
					...
					foreach ($data as $a) {
						...
						if (isset($admin) && $admin && isset($_SESSION['akses_modul']['sirkulasi']) && $_SESSION['akses_modul']['sirkulasi'] == 'on') {
							if ($a['tgl_pengembalian'] == null) {
								echo "<td><a href='#' id='" . $a['id'] . "' data-bs-toggle=\"modal\" data-bs-target=\"#arsipkembali\" class='btn btn-info btn-sm text-white kemdata'><i class=\"mdi mdi-checkbox-marked-circle-outline\"></i> Kembalikan</a></td>";
							} else {
								echo "<td>" . $a['tgl_pengembalian'] . "</td>";
							}
							echo "<td align=\"center\">";
							echo "<a class=\"text-primary me-4\" href='" . site_url('/sirkulasi/vedit/' . $a['id']) . "'><span class='fa fa-edit fa-lg' aria-hidden='true'></span></a>";
							echo "<a class='sdeldata text-danger' id='" . $a['id'] . "' href='#' data-bs-toggle=\"modal\" data-bs-target=\"#deldata\"><i class=\"fa fa-trash fa-lg\"></i></a></td>";
						} else {
							echo "<td>" . $a['tgl_pengembalian'] . "</td>";
						}
						echo "</tr>";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="fsdeldata" class="form-horizontal" role="form" method="post"
                    action="<?= site_url("/sirkulasi/del"); ?>">
...
<div class="modal fade" id="arsipkembali">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="fkemarsip" class="form-horizontal" role="form" method="post"
                    action="<?= site_url("/sirkulasi/kembalikan"); ?>">
