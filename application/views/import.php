...
<div class="row mb-2">
    ...
    <div class="col-md-4">
        <div class="float-end">
            <a href="<?= site_url('/home/dl') ?>" class="btn btn-primary btn-sm me-2"><i class="fa fa-download"></i>
                Export Data</a>&nbsp;
            <a href="<?= base_url('/assets/template_import.xlsx') ?>" class="btn btn-success btn-sm text-white"><i
                    class="fa fa-file-excel"></i> File Template</a>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="import_data" action="<?php echo site_url('/admin/importdata') ?>" enctype="multipart/form-data"
            class="form-horizontal" method="post" role="form">
            <div class="form-group">
                <label for="up_file">Telusuri File:</label>
